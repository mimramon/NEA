...
public class PlayerManager : MonoBehaviour
{
    ...
    public void Gravity()
    {
        ...
        velocity.y += gravity*Time.deltaTime; //adds g to the y value of the vector, Time.deltaTime is the ammount of time between frames and makes it so that framerate doesnt affect speed
